    ...
    <el-main>
      ...
      <el-form ref="contextTypeForm" :model="contextType" label-position="top" :rules="rules">
        ...
        <el-form-item :label="$t('settings.context_type.name')" prop="name" class="context-input">
          <el-input v-model="contextType.name"></el-input>
        </el-form-item>
        ...
        <el-form-item :label="$t('settings.context_type.icon')" prop="icon">
          <el-popover
                  ...
                  trigger="click"
                  v-model="showPopover">
            <font-awesome-icon-chooser @click="showIcon" @close="showPopover = false"></font-awesome-icon-chooser>
...
import FontAwesomeIconChooser from '@/components/settings/FontAwesomeIconChooser'

export default {
  components: {
    ContextType: ContextTypeComponent,
    FontAwesomeIconChooser: FontAwesomeIconChooser
  },
  ...
  methods: {
    ...
    updateLayoutTable() {
      // necessary to update the layout and fit the ContextTypes right, doLayout() not workin
      this.deletable = true
