describe('Context Factors Page', () => {
  ...
  it('can collapse nodes', () => {
    ...
    cy.get(':nth-child(4) > .el-tree-node__content > .custom-tree-node > :nth-child(2)').should('be.visible')
    cy.get('[style="padding-left: 0px;"] > .custom-tree-node > :nth-child(2)').click()
    cy.get(':nth-child(4) > .el-tree-node__content > .custom-tree-node > :nth-child(2)').should('not.be.visible')
  })
  ...
  it('can edit a context factor', () => {
    ...
    cy.get(':nth-child(2) > .el-form > :nth-child(1) > .el-form-item__content > .el-input > .el-input__inner').type('Foo')
    cy.get(':nth-child(2) > .el-form > :nth-child(2) > .el-form-item__content > .el-input > .el-input__inner').type('Bar')
