describe('Context Factors Page', () => {
  ...
  it('can edit a context factor', () => {
    ...
    cy.get(':nth-child(3) > .el-form > :nth-child(1) > .el-form-item__content > .el-input > .el-input__inner').type('Foo')
    cy.get(':nth-child(3) > .el-form > :nth-child(2) > .el-form-item__content > .el-input > .el-input__inner').type('Bar')
